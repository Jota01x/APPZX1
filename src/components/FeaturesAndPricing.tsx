      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center mb-16 lg:mb-20 px-4">
          ...
          <h2 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-black text-white mb-4 uppercase tracking-tighter italic">
            GARANTA SEU <span className="text-blue-500">ACESSO.</span>
          </h2>
          ...
          >
            ...
            <div className="mb-10 flex flex-col">
              <div className="flex flex-col sm:flex-row items-start sm:items-center gap-2 mb-6">
                <span className="bg-white/10 text-white text-[10px] font-black px-3 py-1 rounded-full border border-white/20 whitespace-nowrap">
                  PAGAMENTO ÚNICO
                </span>
                <span className="bg-white/10 text-white text-[10px] font-black px-3 py-1 rounded-full border border-white/20 whitespace-nowrap">
                  ACESSO PARA SEMPRE
              ...
              <div className="mb-2">
                <span className="text-blue-900/50 font-bold uppercase text-sm tracking-[0.2em] line-through italic">DE R$ 397,00</span>
              </div>
            ...
            <a 
              href="https://pay.cakto.com.br/3curgib?affiliate=o9eqogXd"
